...
if (!class_exists('CoolTimelineShortcode')) {
    ...
    $output .= '<div style="opacity:0;" data-showposts="'.$attribute['show-posts'].'" class="'.implode(" ",$main_wrp_cls).'" id="'. $main_wrp_id.'"  data-pagination="' . $enable_navigation . '"  data-pagination-position="' . $navigation_position . '">';
