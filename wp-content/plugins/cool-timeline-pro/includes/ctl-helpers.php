  ...
  function ctl_categories_filters($taxo,$select_cat,$type,$layout){
           ...
           if(isset($select_cat) && $select_cat!==''){
            ...
            if (!empty($terms) && !is_wp_error($terms)) {
               ...
               $filters_html.=sprintf( '<li><a data-type="'.$layout.'"  data-post-count="'.$term->count.'" data-tm-type="'.$type.'" href="#" data-action="'.$action.'" class="ct-cat-filters '.$active.'" data-term-slug="%1$s">%2$s</a></li>',
                      esc_attr($term->slug),
                      esc_html( $term->name )
                  );
                }
