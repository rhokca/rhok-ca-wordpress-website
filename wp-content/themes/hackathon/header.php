  ...
  <div class="hero">
    <?php
      if (!empty($map_id)) {
        echo '<div id="map"></div>'; ?>
        <script>
        mapboxgl.accessToken = 'pk.eyJ1IjoidGFja2FiZXJyeSIsImEiOiJjaW13dno3ajMwM2F4dXBra3VrN3JwY3FsIn0.oodCxPpjL-ZAgpw2koWoHQ';
        var map = new mapboxgl.Map({
            container: 'map', // container id
            style: 'mapbox://styles/mapbox/light-v9', //hosted style id
            center: [-75.717, 45.402], // starting position
